...
async function sendMail(senderId , reciverId , sentData , reciveData ,setSending){
    setSending(true);
    try {
      const responseToSender = await fetch(`https://mail-box-client-65adf-default-rtdb.firebaseio.com/mailbox/
      ...
      await fetch(`https://mail-box-client-65adf-default-rtdb.firebaseio.com/mailbox/
